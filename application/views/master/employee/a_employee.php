              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                      <label for="e_hire_date" class="col-form-label col-lg-4">Tgl Kontrak</label>
                      <div class="col-lg-4 p-0">
                        <input type="date" class="form-control col-lg" name="e_hire_date" id="e_hire_date" min="2004-04-16" max="<?= date('Y-m-d', time()); ?>">
                        <small>Bergabung</small><br>
                        <?= form_error('e_hire_date', '<small class="text-danger">', '</small>') ?>
                      </div>
                      <div class="col-lg-4 p-0">
                        <input type="date" class="form-control col-lg" name="e_hire_end_date" id="e_hire_date" value="<?= date('Y-m-d', strtotime("+7 day")); ?>" min="<?= date('Y-m-d', strtotime("+7 day")); ?>">
                        <small>Berakhir</small><br>
